...
class esteticaview: UIViewController ,UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        if let CurEstetica = CurEstetica{
            ...
            self.labelDescripcion .font = UIFont(name: "Arial", size: 14 * dataAccess.sharedInstance.multiplier)
            self.labelDireccion.font = UIFont(name: "Arial", size: 17 * dataAccess.sharedInstance.multiplier)
       ...
       let data = datosEstetica.GetJson()
        ...
        self.labelNombre.font = UIFont(name: "Arial", size: 14 * dataAccess.sharedInstance.multiplier)
        self.labelDescripcion .font = UIFont(name: "Arial", size: 14 * dataAccess.sharedInstance.multiplier)
        self.labelDireccion.font = UIFont(name: "Arial", size: 14 * dataAccess.sharedInstance.multiplier)
