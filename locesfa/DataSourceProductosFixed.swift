...
class DataSourceProductosFixed: NSObject, UITableViewDataSource {
    ...
    init(cururl: String, posdata: String) {
        ...
        for item in data {
            self.productos.append(Productos_Esteticas(json: item as! NSDictionary))
        }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let item = self.productos[indexPath.row]
        ...
        cell.campo2.text = item.marca
        cell.layoutIfNeeded()
        
        //cell.campo2.text = item.colonia! + " " + item.ciudad!
      //  cell.campo2.text = ""
        cell.id = item.id!
        cell.image1.image = UIImage(named: "products")
    ...
    */
    ...
    internal var productos = [Productos_Esteticas]()
